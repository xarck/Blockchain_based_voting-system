...
contract Election {
    ...
    function addCandidate(
        ...
        candidates[numCandidates] = Candidate(name,description,imgHash,0,numCandidates);
        numCandidates++;
    }
    ...
    function getCandidate(uint8 candidateID) public view returns (Candidate memory){
